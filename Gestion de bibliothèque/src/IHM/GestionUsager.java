...
public class GestionUsager extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        prenomLabel.setForeground(Color.MAGENTA);
        ...
        nomLabel.setForeground(Color.MAGENTA);
        nomLabel.setText("Nom  ");

        telLabel.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        telLabel.setForeground(Color.MAGENTA);
        ...
        prenomLabel1.setForeground(Color.MAGENTA);
